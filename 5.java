...
public class hgcjgh {
    ...
    public static void main(String[] a) {
        ...
        try {
            ...
            vm.add(new Vm(0, id, 250, 1, 2048, 1000, 10000, "Xen", new CloudletSchedulerTimeShared()));
            vm.add(new Vm(1, id, 500, 1, 2048, 1000, 10000, "Xen", new CloudletSchedulerTimeShared()));
    ...
    static Datacenter createDC(String n) {
        ...
        p1.add(new Pe(0, new PeProvisionerSimple(1000)));

        List<Pe> p2 = new ArrayList<>();
        p2.add(new Pe(0, new PeProvisionerSimple(1000)));

        List<Host> h = new ArrayList<>();

        h.add(new Host(0, new RamProvisionerSimple(2048), new BwProvisionerSimple(10000), 1000000, p1, new VmSchedulerTimeShared(p1)));
        h.add(new Host(1, new RamProvisionerSimple(2048), new BwProvisionerSimple(10000), 1000000, p2, new VmSchedulerTimeShared(p2)));
